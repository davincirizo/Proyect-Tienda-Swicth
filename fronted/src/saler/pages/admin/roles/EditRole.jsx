...
import EditCalendarRoundedIcon from "@mui/icons-material/EditCalendarRounded.js";
...
function EditRole(props) {
    ...
    const edit_role = async (data) =>{
        ...
        try{
            setLoading(true)
            const res = await roleApi.put(`/${role.id}`,{
                name:data.name,
    ...
    <>
      ...
      <Modal
          ...
          <Box sx={style}>
              ...
              <form  onSubmit={handleSubmit(edit_role)} >
                                  ...
                                  <ul>
                                      ...
                                      {filter_permissions.map((permission) => (
                                          ...
                                          (<div key={permission.id} >
                                              ...
                                              <Checkbox
                                                  value={permission.id}
                                                  defaultChecked={permissionsSelected.map(r => r).includes(permission.id)}
